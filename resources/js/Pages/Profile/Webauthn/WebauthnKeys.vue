    ...
    <div>
      ...
      <div v-else class="p-6 sm:px-20 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800">
                    ...
                    <tbody class="bg-white dark:bg-slate-900 divide-y divide-gray-200 dark:divide-slate-800">
                        ...
                        <tr v-for="key in webauthnKeys" :key="key.id">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <!-- <ConfirmsPassword @confirmed="keyBeingDeleted = key.id">
                                    <SecondaryButton class="ml-2 pointer text-indigo-400 dark:text-indigo-600 hover:text-indigo-600 hover:dark:text-indigo-400">
                                        Delete
                                    </SecondaryButton>
                                </ConfirmsPassword> -->
            ...
            <div class="mt-8 text-2xl">
                <!-- <ConfirmsPassword @confirmed="showRegisterModal">
                    <Button type="button">
                        Register a new key
                    </Button>
                </ConfirmsPassword> -->
