...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Detalles de Cuenta</h2>
        ...
        <form @submit.prevent="form.patch(route('setting.update'))" class="mt-6 space-y-6">
